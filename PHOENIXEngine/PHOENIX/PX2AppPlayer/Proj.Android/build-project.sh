...
cp -rf $APPPLAY_MYAPP_BIN_ROOT_LOCAL/$APPPLAY_MYAPP_DATAFROM/boostconfig.xml $APPPLAY_MYAPP_ANDROID_ROOT/assets/Data
cp -rf $APPPLAY_MYAPP_BIN_ROOT_LOCAL/$APPPLAY_MYAPP_DATAFROM/boostconfig.lua $APPPLAY_MYAPP_ANDROID_ROOT/assets/Data
cp -rf $APPPLAY_MYAPP_BIN_ROOT_LOCAL/$APPPLAY_MYAPP_DATAFROM/boostproject.list $APPPLAY_MYAPP_ANDROID_ROOT/assets/Data
cp -rf $APPPLAY_MYAPP_BIN_ROOT_LOCAL/$APPPLAY_MYAPP_DATAFROM/plugintopublish.list $APPPLAY_MYAPP_ANDROID_ROOT/assets/Data
cp -rf $APPPLAY_MYAPP_BIN_ROOT_LOCAL/$APPPLAY_MYAPP_DATAFROM/projecttopublish.list $APPPLAY_MYAPP_ANDROID_ROOT/assets/Data
cp -rf $APPPLAY_MYAPP_BIN_ROOT_LOCAL/$APPPLAY_MYAPP_DATAFROM/projecttopublish.list $APPPLAY_MYAPP_ANDROID_ROOT/assets/Data
...
# plugins
cat $APPPLAY_MYAPP_BIN_ROOT_LOCAL/$APPPLAY_MYAPP_DATAFROM/plugintopublish.list | while read line
do
	CATA_NAME=$line
...
# projects
cat $APPPLAY_MYAPP_BIN_ROOT_LOCAL/$APPPLAY_MYAPP_DATAFROM/projecttopublish.list | while read line
do
	CATA_NAME=$line
	if [ $CATA_NAME"xyz" != "xyz" ]; then
		mkdir $APPPLAY_MYAPP_ANDROID_ROOT/assets/Data/$CATA_NAME
...
cat $APPPLAY_MYAPP_BIN_ROOT_LOCAL/$APPPLAY_MYAPP_DATAFROM/boostproject.list | while read line
do
	CATA_NAME=$line
	echo $CATA_NAME
