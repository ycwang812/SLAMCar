...
namespace PX2
{
	...
	const int EngineServerSendMapSelfDrawMsgID = 7;
	const int EngineServerSendMapSelfDrawEndMsgID = 8;

	const int EngineServerSendLidarMsgID = 9;
	const int EngineServerSendRobotState = 10;

	const int EngineClientSendRobotToDoID = 11;
