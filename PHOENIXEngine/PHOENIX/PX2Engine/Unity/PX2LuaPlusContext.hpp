...
namespace PX2
{
	...
	public:
		...
		virtual bool CallFunction(const std::string &funName, double data0,
			double data1);

		virtual bool CallEngineUpdate(double appSeconds, double elapsedSeconds);
		virtual bool CallProjectUpdate(double appSeconds, double elapsedSeconds,
			bool reGet = false);
	...
	protected:
		...
		LuaPlus::LuaObject *mEngineUpdate;
		LuaPlus::LuaObject *mEngineProjectUpdate;
	};
