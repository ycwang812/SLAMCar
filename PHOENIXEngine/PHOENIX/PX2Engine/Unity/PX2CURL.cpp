...
//----------------------------------------------------------------------------
int CurlObj::PostFile(const std::string &url, const std::string &filename)
{
	CURLcode res;
	FILE* fptr;
	...
	StringHelp::SplitFilename(filename, outPath, outFilename);

	/* Fill in the filename field */
	curl_formadd(&formpost,
		&lastptr,
		CURLFORM_COPYNAME, "filename",
		CURLFORM_COPYCONTENTS, outFilename.c_str(),
		CURLFORM_END);
