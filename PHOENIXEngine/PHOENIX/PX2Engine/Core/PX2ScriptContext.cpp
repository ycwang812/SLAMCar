...
//----------------------------------------------------------------------------
bool ScriptContext::CallFunction(const std::string &funName, double data0,
	double data1)
{
	PX2_UNUSED(funName);
	PX2_UNUSED(data0);
...
//----------------------------------------------------------------------------
bool ScriptContext::CallEngineUpdate(double appSeconds, double elapsedSeconds)
{
	PX2_UNUSED(appSeconds);
	PX2_UNUSED(elapsedSeconds);
...
//----------------------------------------------------------------------------
bool ScriptContext::CallProjectUpdate(double appSeconds, double elapsedSeconds,
	bool reGet)
{
	PX2_UNUSED(appSeconds);
	PX2_UNUSED(elapsedSeconds);
