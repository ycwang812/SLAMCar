...
namespace PX2
{
	...
	class PX2_ENGINE_ITEM PathingNode
	{
		float m_tolerance;
		Vector3f m_pos;
	...
	class PX2_ENGINE_ITEM PathingArc
	{
		float m_weight;
	...
	class PX2_ENGINE_ITEM PathPlan
	{
		friend class AStar;
	...
	class PX2_ENGINE_ITEM PathPlanNode
	{
	...
	class PX2_ENGINE_ITEM PathingGraph
	{
	...
	public:
		...
		void SetMapData(const std::vector<unsigned char> mapData, 
			int mapDataWidth, int mapDataHeight,
