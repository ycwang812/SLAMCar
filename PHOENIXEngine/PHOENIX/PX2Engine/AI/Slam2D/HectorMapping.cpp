...
HectorMapping::HectorMapping(): lastGetMapUpdateIndex(-100)
{
  ...
  p_map_resolution_ = 0.03;//0.08;//0.025; // 0.08
  p_map_size_ = 400;
  p_map_start_x_ = 0.5; 
  p_map_start_y_ = 0.5;
  ...
  p_sqr_laser_min_dist_ = static_cast<float>(RANGE_MIN * RANGE_MIN);
  p_sqr_laser_max_dist_ = static_cast<float>(RANGE_MAX * RANGE_MAX);
