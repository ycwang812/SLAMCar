...
//----------------------------------------------------------------------------
inline void Robot::SetLidarIngoreRadius(float radius)
{
	mLidarIngoreRadius = radius;
}
//----------------------------------------------------------------------------
inline float Robot::GetLidarIngoreRadius() const
{
	return mLidarIngoreRadius;
}
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
inline int Robot::GetMapWidth() const
{
	return mMapDataPtr->MapStruct.MapWidth;
}
//----------------------------------------------------------------------------
inline int Robot::GetMapHeight() const
{
	return mMapDataPtr->MapStruct.MapHeight;
}
//----------------------------------------------------------------------------
